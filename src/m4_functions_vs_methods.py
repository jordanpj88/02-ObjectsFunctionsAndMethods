...
def try_methods():
    ...
    ###########################################################################
    methods_turtle = rg.SimpleTurtle('turtle')
    methods_turtle.pen = rg.Pen('brown', 5)
    methods_turtle.forward(150)
    methods_turtle.left(90)
    methods_turtle.forward(50)
    methods_turtle.backward(100)
