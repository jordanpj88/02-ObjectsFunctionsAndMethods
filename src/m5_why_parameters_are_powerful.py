...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50), 10, 20, 'blue', 2)
    even_better_draw_circles(rg.Point(-200,0), 40, 5, 'green', 5)
...
def better_draw_circles(point, radii_increase):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(radii_increase * k)  # Radius 15, 30, 45, 60, ...
